export declare const STREAMMY_CALL_STATUSES: readonly ["initiated", "ringing", "accepted", "declined", "missed", "ongoing", "ended", "cancelled", "failed"];
export type CallStatus = (typeof STREAMMY_CALL_STATUSES)[number];
export declare const STREAMMY_CALL_TYPES: readonly ["audio", "video"];
